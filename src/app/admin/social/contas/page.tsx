    ...
    <main className="min-h-screen bg-voyia-dark">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 space-y-6">
        <div className="bg-blue-900/20 border border-blue-500/40 rounded-lg p-4 text-sm text-blue-100">
          ...
          consulta automaticamente as páginas Facebook ligadas ao seu System User Token e
          cadastra todas as contas Instagram Business/Creator associadas. Idempotente —
          chama várias vezes sem problema.
        </div>
