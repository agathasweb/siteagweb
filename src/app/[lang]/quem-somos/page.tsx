  ...
  'pt-BR': {
    ...
    markets: {
      ...
      items: [
        ...
        { icon: '🛒', title: 'E-commerce e SaaS B2B', body: 'Hospedagem gerenciada, performance e otimização de conversão, alinhadas ao funil real do cliente.' },
  ...
  es: {
    ...
    markets: {
      ...
      items: [
        ...
        { icon: '🛒', title: 'E-commerce y SaaS B2B', body: 'Alojamiento gestionado, performance y optimización de conversión, alineados al embudo real del cliente.' },
  ...
  'en-US': {
    ...
    markets: {
      ...
      items: [
        ...
        { icon: '🛒', title: 'E-commerce and B2B SaaS', body: 'Managed hosting, performance and conversion optimization, aligned with the real customer funnel.' },
  ...
  'en-GB': {
    ...
    markets: {
      ...
      items: [
        ...
        { icon: '💬', title: 'WhatsApp Business support', body: 'Meta Official API with our Voyia platform: no markup, unlimited agents, integration with CRMs and ERPs.' },
        { icon: '🏥', title: 'Healthcare and pharmacy', body: 'Systems with regulation-specific filters — where we started in 2010 with a parenteral nutrition system.' },
        { icon: '🛒', title: 'E-commerce and B2B SaaS', body: 'Managed hosting, performance and conversion optimisation, aligned with the real customer funnel.' },
